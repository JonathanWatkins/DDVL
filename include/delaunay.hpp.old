...
*/
static void compute_circle( point2d_t *pt0, point2d_t *pt1, point2d_t *pt2, double *cx, double *cy, double *radius )
{
...
static void del_link( delaunay_t *result, delaunay_t *left, delaunay_t *right )
{
	...
	//std::cout << left->points << " " << right->points << std::endl;
	...
	//std::cout << ml->idx << "   " << mr->idx << std::endl;
 ...
 */
int delaunay2d(double *points, int num_points, int **faces)
{
	delaunay_t	del;
