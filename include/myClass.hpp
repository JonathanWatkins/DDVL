...
class CDelLine {
  ...
  public:
	...
	{
		return 	(fabs(x1-a.x1)<0.00001 && fabs(y1 - a.y1) < 0.00001 && fabs(x2 - a.x2) < 0.00001 && fabs(y2 - a.y2) < 0.00001) ||
